		...
		<div class="col-md-8 col-md-offset-2 col-xs-offset-1 col-xs-10">
			...
			<?php $comment_args = array( 'title_reply'=>__('Got Something To Say:', 'romangie'),
				'fields' => apply_filters( 'comment_form_default_fields', 
						...
						), 'comment_field' => '<p>' . '<label for="comment">' . __( 'Let us know what you have to say:' , 'romangie') . '</label>' . '<textarea id="comment" name="comment" cols="45" rows="8" class="form-control" style="width: 100%" aria-required="true"></textarea>' . '</p>', 
							'comment_notes_after' => '',
